...
export const EVENT_VERBS: Record<string, string> = {
  ...
  // Incoterms 2020 terms (CFR, CIF, CIP, CPT, DAP, DDP, DPU, EXW, FAS, FCA)
  HandedToFirstCarrier: 'hands the goods to the first carrier',
  HandedToCarrier: 'hands the goods to the carrier',
  MadeAvailableAtDestination: 'makes the goods available at destination',
  GoodsMadeAvailable: 'makes the goods available',
  UnloadedAtDestination: 'unloads the goods at destination',
  ArrivedAtDestination: 'records arrival at destination',
  DeliveredAlongside: 'delivers alongside the vessel',
  ScheduleNotified: 'notifies the schedule',
  ScheduleRightAgreed: 'agrees the right to set the schedule',
  CarriageContracted: 'contracts the carriage',
  CarrierNominated: 'nominates the carrier',
  CarrierFailedToTakeCharge: 'records that the carrier failed to take charge',
  InsuranceObtained: 'obtains insurance',
  InsuranceDocProvided: 'provides the insurance document',
  AdditionalCoverRequested: 'requests additional insurance cover',
  AdditionalCoverInfoGiven: 'gives the information for additional cover',
  AdditionalCoverObtained: 'obtains additional insurance cover',
  AdditionalCoverPaid: 'pays for the additional cover',
  ImportCleared: 'clears for import',
  ClearedByBuyer: 'clears the goods',
  OnBoardBLAgreed: 'agrees to an on-board bill of lading',
  BLInstructionGiven: 'instructs the carrier to issue the bill of lading',
  OnBoardBLIssued: 'issues the on-board bill of lading',
  OnBoardBLForwarded: 'forwards the on-board bill of lading',
  // sale / rental events
  PaidLate: 'pays late',
  DamageReported: 'reports damage',
  UnLoaded: 'unloads',
