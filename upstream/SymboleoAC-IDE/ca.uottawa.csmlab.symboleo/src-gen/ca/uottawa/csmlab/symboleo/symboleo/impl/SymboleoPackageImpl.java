...
public class SymboleoPackageImpl extends EPackageImpl implements SymboleoPackage
{
   ...
   * @generated
   */
  private EClass eselfventEClass = null;
   ...
   * @generated
   */
  private EClass resourceObligationEClass = null;
   ...
   * @generated
   */
  private EClass resourcePowerEClass = null;
   ...
   * @generated
   */
  private EClass resourceOntologyTypeEClass = null;
   ...
   * @generated
   */
  private EClass resourceACPolicyEClass = null;
   ...
   * @generated
   */
  private EClass resourceDotEClass = null;
   ...
   * @generated
   */
  private EClass operationDotExpressionEClass = null;
   ...
   * @generated
   */
  private EClass pArithmeticEClass = null;
   ...
   */
  @Override
  public EReference getModel_Acpolicys()
  {
   ...
   */
  @Override
  public EReference getRegularType_ThirdParty()
  {
  ...
  {
    return (EReference)regularTypeEClass.getEStructuralFeatures().get(3);
  }
   ...
   */
  @Override
  public EReference getRegularType_AResource()
  {
    return (EReference)regularTypeEClass.getEStructuralFeatures().get(4);
  }
   ...
   */
  @Override
  public EAttribute getAResource_Name()
  {
    return (EAttribute)aResourceEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getACPolicy_Controller()
  {
   ...
   */
  @Override
  public EReference getController_ControllerType()
  {
   ...
   */
  @Override
  public EReference getRule_AccessedRole()
  {
   ...
   */
  @Override
  public EReference getRule_AccessedResource()
  {
   ...
   */
  @Override
  public EReference getRule_Controller()
  {
   ...
   */
  @Override
  public EReference getObligation_Controller()
  {
   ...
   */
  @Override
  public EReference getPower_Controller()
  {
    return (EReference)powerEClass.getEStructuralFeatures().get(6);
  }
   ...
   */
  @Override
  public EClass getEselfvent()
  {
    return eselfventEClass;
  }
   ...
   */
  @Override
  public EClass getResourceObligation()
  {
    return resourceObligationEClass;
  }
   ...
   */
  @Override
  public EReference getResourceObligation_ResourceOp()
  {
    return (EReference)resourceObligationEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getResourcePower()
  {
    return resourcePowerEClass;
  }
   ...
   */
  @Override
  public EReference getResourcePower_ResourcePo()
  {
    return (EReference)resourcePowerEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getResourceOntologyType()
  {
    return resourceOntologyTypeEClass;
  }
   ...
   */
  @Override
  public EReference getResourceOntologyType_ResourceOn()
  {
    return (EReference)resourceOntologyTypeEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getResourceACPolicy()
  {
    return resourceACPolicyEClass;
  }
   ...
   */
  @Override
  public EReference getResourceACPolicy_ResourceAc()
  {
    return (EReference)resourceACPolicyEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getResourceAttribute_ResourceAt()
  {
    return (EReference)resourceAttributeEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getResourceDot()
  {
    return resourceDotEClass;
  }
   ...
   */
  @Override
  public EReference getResourceDot_ResourceDot()
  {
    return (EReference)resourceDotEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getResourceOperation_ResourceOpe()
  {
   ...
   */
  @Override
  public EClass getOperationDotExpression()
  {
    return operationDotExpressionEClass;
  }
   ...
   */
  @Override
  public EReference getOperationDotExpression_Ref()
  {
    return (EReference)operationDotExpressionEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getOperationDotExpression_Tail()
  {
    return (EReference)operationDotExpressionEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EAttribute)operationRefEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getPArithmetic()
  {
    return pArithmeticEClass;
  }
   ...
   */
  @Override
  public EReference getPArithmetic_Left()
  {
    return (EReference)pArithmeticEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getPArithmetic_Op()
  {
    return (EAttribute)pArithmeticEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getPArithmetic_Right()
  {
    return (EReference)pArithmeticEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EAttribute getDataTransfer_Name()
  {
   ...
   */
  @Override
  public EReference getDataTransfer_Variable()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(modelEClass, MODEL__ACPOLICYS);
    ...
    createEAttribute(aResourceEClass, ARESOURCE__NAME);

    acPolicyEClass = createEClass(AC_POLICY);
    createEReference(acPolicyEClass, AC_POLICY__CONTROLLER);

    controllerEClass = createEClass(CONTROLLER);
    createEReference(controllerEClass, CONTROLLER__CONTROLLER_TYPE);

    ruleEClass = createEClass(RULE);
    createEAttribute(ruleEClass, RULE__NAME);
    createEAttribute(ruleEClass, RULE__ACTION);
    createEReference(ruleEClass, RULE__PERMISSION);
    createEReference(ruleEClass, RULE__ACCESSED_ROLE);
    createEReference(ruleEClass, RULE__ACCESSED_RESOURCE);
    createEReference(ruleEClass, RULE__CONTROLLER);
    ...
    createEReference(obligationEClass, OBLIGATION__CONTROLLER);
    ...
    createEReference(powerEClass, POWER__CONTROLLER);
    ...
    eselfventEClass = createEClass(ESELFVENT);
    ...
    resourceObligationEClass = createEClass(RESOURCE_OBLIGATION);
    createEReference(resourceObligationEClass, RESOURCE_OBLIGATION__RESOURCE_OP);

    resourcePowerEClass = createEClass(RESOURCE_POWER);
    createEReference(resourcePowerEClass, RESOURCE_POWER__RESOURCE_PO);

    resourceOntologyTypeEClass = createEClass(RESOURCE_ONTOLOGY_TYPE);
    createEReference(resourceOntologyTypeEClass, RESOURCE_ONTOLOGY_TYPE__RESOURCE_ON);

    resourceACPolicyEClass = createEClass(RESOURCE_AC_POLICY);
    createEReference(resourceACPolicyEClass, RESOURCE_AC_POLICY__RESOURCE_AC);

    resourceAttributeEClass = createEClass(RESOURCE_ATTRIBUTE);
    createEReference(resourceAttributeEClass, RESOURCE_ATTRIBUTE__RESOURCE_AT);

    resourceDotEClass = createEClass(RESOURCE_DOT);
    createEReference(resourceDotEClass, RESOURCE_DOT__RESOURCE_DOT);

    resourceOperationEClass = createEClass(RESOURCE_OPERATION);
    createEReference(resourceOperationEClass, RESOURCE_OPERATION__RESOURCE_OPE);

    operationDotExpressionEClass = createEClass(OPERATION_DOT_EXPRESSION);
    createEReference(operationDotExpressionEClass, OPERATION_DOT_EXPRESSION__REF);
    createEReference(operationDotExpressionEClass, OPERATION_DOT_EXPRESSION__TAIL);

    operationRefEClass = createEClass(OPERATION_REF);
    createEAttribute(operationRefEClass, OPERATION_REF__OPERATION);
    ...
    pArithmeticEClass = createEClass(PARITHMETIC);
    createEReference(pArithmeticEClass, PARITHMETIC__LEFT);
    createEAttribute(pArithmeticEClass, PARITHMETIC__OP);
    createEReference(pArithmeticEClass, PARITHMETIC__RIGHT);
    ...
    createEAttribute(dataTransferEClass, DATA_TRANSFER__NAME);
    createEReference(dataTransferEClass, DATA_TRANSFER__VARIABLE);
  ...
  public void initializePackageContents()
  {
    ...
    eselfventEClass.getESuperTypes().add(this.getEvent());
    ...
    resourceObligationEClass.getESuperTypes().add(this.getResource());
    resourcePowerEClass.getESuperTypes().add(this.getResource());
    resourceOntologyTypeEClass.getESuperTypes().add(this.getResource());
    resourceACPolicyEClass.getESuperTypes().add(this.getResource());
    resourceAttributeEClass.getESuperTypes().add(this.getResource());
    resourceDotEClass.getESuperTypes().add(this.getResource());
    resourceOperationEClass.getESuperTypes().add(this.getResource());
    operationDotExpressionEClass.getESuperTypes().add(this.getRef());
    operationRefEClass.getESuperTypes().add(this.getRef());
    ...
    pArithmeticEClass.getESuperTypes().add(this.getProposition());
    ...
    dataTransferEClass.getESuperTypes().add(this.getEvent());
    ...
    contractEventEClass.getESuperTypes().add(this.getEselfvent());
    ...
    initEReference(getModel_Acpolicys(), this.getACPolicy(), null, "acpolicys", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRegularType_ThirdParty(), this.getThirdParty(), null, "thirdParty", null, 0, 1, RegularType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRegularType_AResource(), this.getAResource(), null, "aResource", null, 0, 1, RegularType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getOperation_Precondition(), this.getCondition(), null, "precondition", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOperation_Postcondition(), this.getCondition(), null, "postcondition", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(returnTypeEClass, ReturnType.class, "ReturnType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getReturnType_Type(), this.getParameterType(), null, "type", null, 0, 1, ReturnType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(aResourceEClass, AResource.class, "AResource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getAResource_Name(), ecorePackage.getEString(), "name", null, 0, 1, AResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(acPolicyEClass, ACPolicy.class, "ACPolicy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getACPolicy_Controller(), this.getController(), null, "controller", null, 0, -1, ACPolicy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(controllerEClass, Controller.class, "Controller", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getController_ControllerType(), this.getRef(), null, "controllerType", null, 0, 1, Controller.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRule_AccessedRole(), this.getRef(), null, "accessedRole", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRule_AccessedResource(), this.getResource(), null, "accessedResource", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRule_Controller(), this.getRef(), null, "controller", null, 0, 1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getObligation_Controller(), this.getRef(), null, "controller", null, 0, 1, Obligation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPower_Controller(), this.getRef(), null, "controller", null, 0, 1, Power.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(eselfventEClass, Eselfvent.class, "Eselfvent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEClass(resourceObligationEClass, ResourceObligation.class, "ResourceObligation", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getResourceObligation_ResourceOp(), this.getObligation(), null, "resourceOp", null, 0, 1, ResourceObligation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(resourcePowerEClass, ResourcePower.class, "ResourcePower", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getResourcePower_ResourcePo(), this.getPower(), null, "resourcePo", null, 0, 1, ResourcePower.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(resourceOntologyTypeEClass, ResourceOntologyType.class, "ResourceOntologyType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getResourceOntologyType_ResourceOn(), this.getOntologyType(), null, "resourceOn", null, 0, 1, ResourceOntologyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(resourceACPolicyEClass, ResourceACPolicy.class, "ResourceACPolicy", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getResourceACPolicy_ResourceAc(), this.getACPolicy(), null, "resourceAc", null, 0, 1, ResourceACPolicy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getResourceAttribute_ResourceAt(), this.getAttribute(), null, "resourceAt", null, 0, 1, ResourceAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(resourceDotEClass, ResourceDot.class, "ResourceDot", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getResourceDot_ResourceDot(), this.getRef(), null, "resourceDot", null, 0, 1, ResourceDot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getResourceOperation_ResourceOpe(), this.getOperation(), null, "resourceOpe", null, 0, 1, ResourceOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(operationDotExpressionEClass, OperationDotExpression.class, "OperationDotExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOperationDotExpression_Ref(), this.getRef(), null, "ref", null, 0, 1, OperationDotExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getOperationDotExpression_Tail(), this.getOperation(), null, "tail", null, 0, 1, OperationDotExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(operationRefEClass, OperationRef.class, "OperationRef", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getOperationRef_Operation(), ecorePackage.getEString(), "operation", null, 0, 1, OperationRef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(pArithmeticEClass, PArithmetic.class, "PArithmetic", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getPArithmetic_Left(), this.getProposition(), null, "left", null, 0, 1, PArithmetic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getPArithmetic_Op(), ecorePackage.getEString(), "op", null, 0, 1, PArithmetic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPArithmetic_Right(), this.getProposition(), null, "right", null, 0, 1, PArithmetic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getDataTransfer_Name(), ecorePackage.getEString(), "name", null, 0, 1, DataTransfer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDataTransfer_Variable(), this.getRef(), null, "variable", null, 0, 1, DataTransfer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPointAtomContractEvent_ContractEvent(), this.getEselfvent(), null, "contractEvent", null, 0, 1, PointAtomContractEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
