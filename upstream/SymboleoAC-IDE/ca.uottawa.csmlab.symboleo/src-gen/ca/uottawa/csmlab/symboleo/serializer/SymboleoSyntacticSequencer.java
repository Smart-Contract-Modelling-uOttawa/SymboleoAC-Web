...
public class SymboleoSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Model_ConstraintsKeyword_18_0_q;
	...
	protected AbstractElementAlias match_RegularType_IsAKeyword_2_1_0_or_IsAnKeyword_2_1_1;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (SymboleoGrammarAccess) access;
		match_Model_ConstraintsKeyword_18_0_q = new TokenAlias(false, true, grammarAccess.getModelAccess().getConstraintsKeyword_18_0());
		...
		match_RegularType_IsAKeyword_2_1_0_or_IsAnKeyword_2_1_1 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getRegularTypeAccess().getIsAKeyword_2_1_0()), new TokenAlias(false, false, grammarAccess.getRegularTypeAccess().getIsAnKeyword_2_1_1()));
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Model_ConstraintsKeyword_18_0_q.equals(syntax))
				emit_Model_ConstraintsKeyword_18_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_RegularType_IsAKeyword_2_1_0_or_IsAnKeyword_2_1_1.equals(syntax))
				emit_RegularType_IsAKeyword_2_1_0_or_IsAnKeyword_2_1_1(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     acpolicys=ACPolicy (ambiguity) 'endContract' (rule end)
	 ...
	 *     rules+=Rule ';' (ambiguity) 'endContract' (rule end)
	 ...
	 * </pre>
	 */
	protected void emit_Model_ConstraintsKeyword_18_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     parameters+=Parameter ')' (ambiguity) 'Preconditions'? 'Postconditions'? 'Obligations'+ ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     obligations+=Obligation ';' (ambiguity) ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     parameters+=Parameter ')' 'Declarations'? 'Preconditions'? 'Postconditions'? (ambiguity) ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     postconditions+=Proposition ';' (ambiguity) ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     preconditions+=Proposition ';' 'Postconditions'? (ambiguity) ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     variables+=Variable ';' 'Preconditions'? 'Postconditions'? (ambiguity) ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     parameters+=Parameter ')' 'Declarations'? 'Preconditions'? (ambiguity) 'Obligations'+ ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     preconditions+=Proposition ';' (ambiguity) 'Obligations'+ ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     variables+=Variable ';' 'Preconditions'? (ambiguity) 'Obligations'+ ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     obligations+=Obligation ';' 'Obligations'* ('Surviving' 'Obligations')? (ambiguity) 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     parameters+=Parameter ')' 'Declarations'? 'Preconditions'? 'Postconditions'? 'Obligations'+ ('Surviving' 'Obligations')? (ambiguity) 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     postconditions+=Proposition ';' 'Obligations'+ ('Surviving' 'Obligations')? (ambiguity) 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     preconditions+=Proposition ';' 'Postconditions'? 'Obligations'+ ('Surviving' 'Obligations')? (ambiguity) 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     survivingObligations+=Obligation ';' (ambiguity) 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     variables+=Variable ';' 'Preconditions'? 'Postconditions'? 'Obligations'+ ('Surviving' 'Obligations')? (ambiguity) 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     parameters+=Parameter ')' 'Declarations'? (ambiguity) 'Postconditions'? 'Obligations'+ ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     variables+=Variable ';' (ambiguity) 'Postconditions'? 'Obligations'+ ('Surviving' 'Obligations')? 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     obligations+=Obligation ';' 'Obligations'* (ambiguity) 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     parameters+=Parameter ')' 'Declarations'? 'Preconditions'? 'Postconditions'? 'Obligations'+ (ambiguity) 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     postconditions+=Proposition ';' 'Obligations'+ (ambiguity) 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     preconditions+=Proposition ';' 'Postconditions'? 'Obligations'+ (ambiguity) 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *     variables+=Variable ';' 'Preconditions'? 'Postconditions'? 'Obligations'+ (ambiguity) 'Powers'? 'ACPolicy' acpolicys=ACPolicy
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     name=ID (ambiguity) aResource=AResource
	 
	 * </pre>
	 */
	protected void emit_RegularType_IsAKeyword_2_1_0_or_IsAnKeyword_2_1_1(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
