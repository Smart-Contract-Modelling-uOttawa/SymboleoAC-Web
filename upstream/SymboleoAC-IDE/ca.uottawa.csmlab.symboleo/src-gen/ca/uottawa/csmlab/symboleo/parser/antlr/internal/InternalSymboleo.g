...
entryRuleAResource returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAResourceRule()); }
	iv_ruleAResource=ruleAResource
	{ $current=$iv_ruleAResource.current; }
	EOF;

// Rule AResource
ruleAResource returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleACPolicy returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getACPolicyRule()); }
	iv_ruleACPolicy=ruleACPolicy
	{ $current=$iv_ruleACPolicy.current; }
	EOF;

// Rule ACPolicy
ruleACPolicy returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_PArithmetic_0.current;
			afterParserOrEnumRuleCall();
		}
		(
			(
...
entryRulePArithmetic returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getPArithmeticRule()); }
	iv_rulePArithmetic=rulePArithmetic
	{ $current=$iv_rulePArithmetic.current; }
	EOF;

// Rule PArithmetic
rulePArithmetic returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_DataTransfer_4.current;
			afterParserOrEnumRuleCall();
		}
	)
;
