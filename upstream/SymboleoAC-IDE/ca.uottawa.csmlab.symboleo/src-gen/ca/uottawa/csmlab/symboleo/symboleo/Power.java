 ...
 *   <li>{@link ca.uottawa.csmlab.symboleo.symboleo.Power#getController <em>Controller</em>}</li>
 * </ul>
 *
...
public interface Power extends EObject
{
   ...
   * @see ca.uottawa.csmlab.symboleo.symboleo.SymboleoPackage#getPower_Controller()
   * @model containment="true"
   * @generated
   */
  Ref getController();
  ...
  /**
   * Sets the value of the '{@link ca.uottawa.csmlab.symboleo.symboleo.Power#getController <em>Controller</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
