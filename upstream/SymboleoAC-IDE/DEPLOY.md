...
For MacOS, please use this link to install - [Deploy in Mac](https://github.com/Smart-Contract-Modelling-uOttawa/Symboleo2SC-SymboleoPC-Combined/blob/master/DEPLOY_macOS.md)
...
wsl --install
```
2- After successful installation of WSL, reboot your PC. Then open another Windows terminal and run these commands.
```bash
